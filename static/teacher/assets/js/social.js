...
$(document).ready(function() {
    ...
    var spark1 = new ApexCharts(document.querySelector("#apex-chart-Facebook1-1"), spark1);
    spark1.render();
    ...
    var spark1 = new ApexCharts(document.querySelector("#apex-chart-Facebook1-2"), spark1);
    spark1.render();
    ...
    var spark1 = new ApexCharts(document.querySelector("#apex-chart-Facebook1-3"), spark1);
    spark1.render();    
});
...
$(document).ready(function() {
    var options = {
        ...
        series: [{
            ...
            name: '个人准确率',
            data: [76, 85, 99, 98, 87, 91, 91, 88, 94]
        }],
        xaxis: {
